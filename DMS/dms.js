...
DMS.searchUser('bi5b4uib5uib6v54vu6b45b654uibu6b45uib654iub6', (usern) => {
    console.log(usern)
})

/*DMS.updateFeed('iub54i6bibu64', '', 'retg54', 430, res => console.log) */
//DMS.getFeedValue('iub54i6bibu64', '', 'retg54', feed => console.log(feed.value))
