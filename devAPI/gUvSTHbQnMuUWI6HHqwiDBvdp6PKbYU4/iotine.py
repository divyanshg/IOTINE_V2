...
def connect():
  ...
  client = MQTTClient(client_id, mqtt_server, 1883, user=bytes(device_id, 'utf-8'), password=b'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoxLCJ1c2VybmFtZSI6ImRpdiJ9LCJpYXQiOjE1ODg4NzYyMzF9.Jg0PelxAMUYklR27_l4j9CXzrSaQ6M-upor0Uy4ccIU')
