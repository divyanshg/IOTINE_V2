...
async function loadPROPS(dev) {
    ...
    xhttp.open("GET", "https://192.168.31.249:3002/devProps/" + user + "/" + devID, true);
    await xhttp.send();
...
var newdevice = new River({
    ...
    methods: {
        ...
        async getTemplates() {
            ...
            xhttp.open("GET", "https://192.168.31.249:3002/templates/" + user, true);
            await xhttp.send();
        },
        async addTemplate() {
...
var socket = io('https://192.168.31.249:3000/', {
    secure: true,
...
function getTabs() {
    return new Promise((resolve, reject) => {
        ...
        xhttp.open("GET", "https://192.168.31.249:3002/tabs/" + user + "/" + app, true);
        xhttp.send();
    })
}
/*
...
function createLog(feed, fedd, config, bdy) {
    ...
    logCont.innerHTML += "CONNECTED TO " + config.device + "/" + fedd + "<br>Waiting For Data...<br>"
...
async function createWidget() {
    ...
    xhttp.open("GET", "https://192.168.31.249:3002/widgets/" + user + "/" + app, true);
    await xhttp.send();
}
...
async function updateDeviceStatus() {
    ...
    xhttp.open("GET", "https://192.168.31.249:3002/deviceState/" + user, true);
    await xhttp.send()
}
