...
async function loadPROPS(dev) {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/devProps/" + user + "/" + devID, true);
    await xhttp.send();
...
async function loadFeeds(dev) {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/feeds/" + user + "/" + dev, true);
    await xhttp.send();
}
...
var newdevice = new River({
    ...
    methods: {
        ...
        async getTemplates() {
            ...
            xhttp.open("GET", "https://103.50.151.90:3002/templates/" + user, true);
            await xhttp.send();
        },
        async addTemplate() {
            ...
            xhttp.open("POST", "https://103.50.151.90:3002/newTempl/" + user + "/" + name, true);
            await xhttp.send();
        },
...
async function saveDevice(name, templ, did) {
    ...
    xhttp.open("POST", "https://103.50.151.90:3002/newDevice/" + user + "/" + name + "/" + did + "/" +
        templ, true);
    await xhttp.send();
}
...
async function savevDevice(name, templ, did) {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/virtualDevice/" + user + "/" + name + "/" + templ + "/" + did, true);
    await xhttp.send();
}
...
var socket = io('https://103.50.151.90:3000/', {
    secure: true,
...
async function getUser() {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/user/" + username, true);
    await xhttp.send();
}
...
async function getDevices() {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/devices/" + user, true);
    await xhttp.send();
}
...
function getTabs() {
    return new Promise((resolve, reject) => {
        ...
        xhttp.open("GET", "https://103.50.151.90:3002/tabs/" + user + "/" + app, true);
        xhttp.send();
    })
}
/*
...
async function createWidget() {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/widgets/" + user + "/" + app, true);
    await xhttp.send();
}
...
async function updateDeviceStatus() {
    ...
    xhttp.open("GET", "https://103.50.151.90:3002/deviceState/" + user, true);
    await xhttp.send()
}
